...
class _EntitiesResolverGenerator implements FieldResolverGeneratorInterface
{
    ...
    {
        return $type->name === 'Query' && $field->name === '_entities';
    }
    ...
    public function generate(Type $type, FieldDefinition $field, Schema $schema): string
    {
        ...
        return $twig->render('Model/_EntitiesResolver.php.twig', [
